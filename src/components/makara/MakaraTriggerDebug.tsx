...
const STORAGE_KEY = 'makara-trigger-configs';
...
export default function MakaraTriggerDebug() {
  ...
  const handleExportAll = () => {
    ...
    let code = `// Makara stage configurations - Generated from debug tool\n`;
    code += `// Configured maps: ${configuredMaps.length}\n\n`;
    code += `export const MAKARA_CONFIG: Record<string, MapConfig> = {\n`;
