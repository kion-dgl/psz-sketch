...
import { getMapConfig, getDefaultSpawn, type TriggerConfig as ConfigTrigger, type SpawnPoint } from './paruConfig';
...
export default function ParuArea({ mapId, mapName, spawnPosition: propSpawn, spawnRotation: propRotation, triggers: propTriggers, timeOfDay = 'day', weather = 'clear', debugMode: initialDebug = true, children }: ParuAreaProps) {
  ...
  // Get config from paruConfig.ts, with prop overrides
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ marginTop: '0.5rem', color: '#7fff7f' }}>
