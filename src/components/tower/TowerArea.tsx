...
import { getMapConfig, getDefaultSpawn, type TriggerConfig as ConfigTrigger, type SpawnPoint } from './towerConfig';
...
export default function TowerArea({ mapId, mapName, spawnPosition: propSpawn, spawnRotation: propRotation, triggers: propTriggers, timeOfDay = 'day', weather = 'clear', debugMode: initialDebug = true, children }: TowerAreaProps) {
  ...
  // Get config from towerConfig.ts, with prop overrides
  ...
  if (loading) {
    return (
      <div style={{
        ...
        height: '100vh',
        background: 'linear-gradient(135deg, #1a1510 0%, #2a2520 100%)',
        color: 'white'
      }}>
        <p>Loading {mapName}...</p>
      </div>
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ marginTop: '0.5rem', color: '#d4b896' }}>
        ...
        <button
          ...
          style={{
            marginTop: '0.5rem',
            padding: '4px 8px',
            background: showDebugMarkers ? '#aa8855' : '#555',
            color: 'white',
            border: 'none',
            borderRadius: '4px',
            cursor: 'pointer',
      ...
      <Canvas shadows>
        ...
        {/* Distant fog for tower atmosphere */}
        <fog attach="fog" args={[weatherAdjustedLighting.fogColor, 100, 200]} />
        ...
        <Suspense fallback={null}>
          {/* Tower Environment - OUTSIDE Physics */}
          <TowerEnv mapId={mapId} />

          {/* Eternal mote particles */}
