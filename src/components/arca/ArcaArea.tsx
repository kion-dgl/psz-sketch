...
import { getMapConfig, getDefaultSpawn, type TriggerConfig as ConfigTrigger, type SpawnPoint } from './arcaConfig';
...
export default function ArcaArea({ mapId, mapName, spawnPosition: propSpawn, spawnRotation: propRotation, triggers: propTriggers, timeOfDay = 'day', weather = 'clear', debugMode: initialDebug = true, children }: ArcaAreaProps) {
  ...
  // Get config from arcaConfig.ts, with prop overrides
  ...
  if (loading) {
    return (
      <div style={{
        ...
        height: '100vh',
        background: 'linear-gradient(135deg, #1a1a1a 0%, #2a2525 100%)',
        color: 'white'
      }}>
        <p>Loading {mapName}...</p>
      </div>
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ marginTop: '0.5rem', color: '#ccaa77' }}>
        ...
        <button
          ...
          style={{
            marginTop: '0.5rem',
            padding: '4px 8px',
            background: showDebugMarkers ? '#cc8800' : '#555',
            color: 'white',
            border: 'none',
            borderRadius: '4px',
            cursor: 'pointer',
      ...
      <Canvas shadows>
        ...
        <Suspense fallback={null}>
          {/* Arca Environment - OUTSIDE Physics */}
          <ArcaEnv mapId={mapId} />

          {/* Steam and metallic dust particles */}
          <SteamParticles intensity="light" />
