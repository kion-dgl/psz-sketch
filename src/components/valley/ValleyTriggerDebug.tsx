...
const STORAGE_KEY = 'valley-trigger-configs';
...
export default function ValleyTriggerDebug() {
  ...
  const handleExportAll = () => {
    ...
    let code = `// Valley stage configurations - Generated from debug tool\n`;
    code += `// Configured maps: ${configuredMaps.length}\n\n`;
    code += `export const VALLEY_CONFIG: Record<string, MapConfig> = {\n`;
